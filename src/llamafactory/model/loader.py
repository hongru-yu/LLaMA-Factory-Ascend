...
def load_tokenizer(model_args: "ModelArguments") -> "TokenizerModule":
    ...
    print("load_tokenizer init_kwargs：", init_kwargs)
    print("use_fast_tokenizer：", model_args.use_fast_tokenizer)
    print("model_name_or_path：", model_args.model_name_or_path)
    print("split_special_tokens：", model_args.split_special_tokens)
    print("**********************************************************************")
    try:
...
def load_config(model_args: "ModelArguments") -> "PretrainedConfig":
    ...
    """
    init_kwargs = _get_init_kwargs(model_args)
    print("config init_kwargs：", init_kwargs)
    print("**********************************************************************")
...
def load_model(
    ...
    print("init_kwargs result：", init_kwargs)
    print("**********************************************************************")
